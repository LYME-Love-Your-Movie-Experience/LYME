    ...
    function getUser(key){
      return new Promise(function(resolve, reject) {
        ...
        ref.on('value', function(snapshot) {
          ...
          $('#first_name').val(sv.firstName).css('color', 'white')
          $('#first-name-label').addClass('active')
          $('#last_name').val(sv.lastName).css('color', 'white')
          $('#last-name-label').addClass('active')
          $('#email').val(sv.email).css('color', 'white')
          $('#email-label').addClass('active')          
          $('#city_name').val(sv.city).css('color', 'white')
          $('#city-label').addClass('active')
          // $('#state-picker').val(sv.state)
          $('#state-picker option[value=State]').prop('selected', false)        
          $('#state-picker option[value='+sv.state+']').prop('selected', true)
          resolve(true)  
        })
      })
    }
